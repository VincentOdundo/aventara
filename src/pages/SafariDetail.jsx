...
export default function SafariDetail() {
  ...
  return (
    <Layout>
      ...
      {/* Sticky Nav Bar */}
      <section className="bg-surface-container-lowest editorial-shadow sticky top-[60px] z-30 border-b border-outline-variant/10">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-12 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Itinerary */}
            <div id="itinerary" className="mb-16 scroll-mt-32">
            ...
            {/* Included / Excluded */}
            <div id="included" className="scroll-mt-32">
              <h2 className="text-3xl font-headline font-bold text-primary mb-8">
                What's Included
              </h2>
          ...
          <div className="lg:col-span-1">
            <div
              id="booking"
              className="sticky top-[120px] bg-surface-container-lowest rounded-2xl editorial-shadow p-8 scroll-mt-32"
            >
