...
export const package4DayMaraNakuru = {
  ...
  subtitle:
    "Experience the legendary Big Five and the world-famous Great Rift Valley rhino sanctuary on this ultimate 4-day Kenyan adventure.",
  days: 4,
  country: "kenya",
  ...
  highlights: [
    ...
    "Exclusive access to the Lake Nakuru Rhino Sanctuary",
    "Witness vibrant flamingo flocks over the Great Rift Valley lakes",
    "Breathtaking panoramic Great Rift Valley scenery year-round",
  ],
  included: [
    "Transportation in a customized premium safari vehicle",
    "Services of a professional, highly-rated local guide/driver",
    "3 nights of carefully selected authentic accommodation",
    "All gourmet and camp meals as per itinerary",
    "Comprehensive park entry fees and government taxes",
    "Extensive daily game drives",
  ...
  excluded: [
    ...
    "Optional cultural activities (e.g., Maasai village visit)",
  ...
  itinerary: [
    {
      ...
      highlights: [
        ...
        "Spot prowling lions and majestic elephants",
        "Experience the iconic golden savannah sunset",
      ],
    },
    {
      day: 2,
      ...
      highlights: [
        ...
        "Witness the awe-inspiring Great Migration (seasonal)",
        "Exclusive picnic lunch surrounded by wild nature",
      ],
    },
    {
      day: 3,
      ...
      highlights: [
        ...
        "Vibrant seasonal Flamingo flocks",
        "Rare Rothschild giraffes photography",
      ],
    },
    {
      day: 4,
      ...
      image: null,
      highlights: [
        "Action-packed morning game drive",
        "Golden-hour wildlife photography",
        "Seamless and comfortable return to Nairobi",
      ],
    },
  ],
};
